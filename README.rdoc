...
Un sevreur nodejs avec des ressources limités peut effectuer plus de requetes en un temps restreint qu'un serveur rails.
Cependant il n'y avait rien dans ce projet qui nécéssitais de se poser une telle question.
